...
df = pd.read_csv('C:/Users/danie/OneDrive/Work/Career/Coding/Folio/Budgeting app/data/Raw/8_nov_24/budgeting_data_raw.csv')
...
conditions = [
    ...
    df['Description'].str.contains('Investment', case=False, na=False),      # Investments payment
...
choices = [
    ...
    "Investments payment",                     # For Investment
...
df.to_excel(f'C:/Users/danie/OneDrive/Work/Career/Coding/Folio/Budgeting app/data/Reporting/budgeting_data_rep_{day}_{month}_{year}.xlsx', index=False)
